...
//     postcondition: x=y;A new sequence x has been created, each item in x 
//     is same as each item in sequence y
//     if there is current item in sequence y, then there will be a same 
//     current item in the new sequence x. 
//
//	 void operator +=(const sequence& source)
...
//    precondition: index is less than used
//    postcondition: each item of the sequence can be accessed by index 
