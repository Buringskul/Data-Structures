...
// 2. The root pointer is a pointer to the root node of a binary search tree that contains the bags items.
...
int main( )
{
    ...
    cout << "If you submit this BAG to the me now, you will have\n";
    cout << sum << " points out of the ";
    cout << 80;
    cout << " points from this test program.\n";
	cout << "The other 20 points will based on your coding style.\n";
